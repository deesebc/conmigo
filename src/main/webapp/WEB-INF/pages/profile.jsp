...
<div class="starter-template col-md-12">
	...
	<form:form modelAttribute="form" method="put" action="${pageContext.request.contextPath}/profile" cssClass="form-signin">
		<div class="col-md-12">
		...
		<div class="form-group row">
			...
			<label for="repeatPassword" class="col-form-label">Password</label>
		     <div class="col">
