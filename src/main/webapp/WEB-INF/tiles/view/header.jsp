  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item ${fn:contains(requestScope['javax.servlet.forward.request_uri'], 'events') ? 'active':''}">
      	<a class="nav-link" href="/events/"><spring:message code="l.events" /></a>
      </li>
      <li class="nav-item ${fn:contains(requestScope['javax.servlet.forward.request_uri'], 'messages') ? 'active':''}">
      	<a class="nav-link" href="/messages/"><spring:message code="l.messages" /></a>
      </li>
      <security:authorize access="isFullyAuthenticated()">
	    ...
	    <li><a class="nav-link" href="/logout"><spring:message code="l.logut" /></a></li>
