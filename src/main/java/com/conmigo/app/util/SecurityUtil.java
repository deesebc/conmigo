...
public final class SecurityUtil {
    ...
    public static CustomUserDetails getUserDetails() {
        ...
        if (isFullyAuthenticated()) {
            usuario = (CustomUserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        }
        return usuario;
    }
    ...
    public static Long getIdUser() {
        Long idUser = null;
        if (isFullyAuthenticated()) {
            final CustomUserDetails usuario = (CustomUserDetails) SecurityContextHolder.getContext().getAuthentication()
                    .getPrincipal();
